...
- [ ] Initial sentence to allow this to flow from the previous chapter
- [ ] brief overview of the chapter and how it is linked to other chapters
- [ ] state objectives and key takeaways
- [ ] Explain the importance of this chapter
...
*** if there were 2 trucks moving relative to eachother, no matter which trucks frame you are in you would observe that the other lorry's time/clock is moving slower
...
%███████████████████████████████████████████████████████████████████
\subsection{No Width Contraction} \label{sect: width contraction}
