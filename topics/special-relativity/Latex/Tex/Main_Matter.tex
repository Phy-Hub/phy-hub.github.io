...
*** What is the change in the rate of change of direction at a coordinate of the light (find in both frames)
...
for the denominator of this using $M = \sqrt{x^2 + y^2 + \gamma_u^2 z^2} $
