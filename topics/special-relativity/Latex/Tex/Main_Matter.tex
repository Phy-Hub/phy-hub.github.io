...
\begin{derivation}
	...
	\begin{equation}
		\begin{split}
			T'_{p} & = \gamma^2\frac{u'}{c^2}z' + \sqrt{\left(-\gamma^2\frac{u'}{c^2} l_z' \right)^2+\frac{\gamma^2}{c^2}(l_x'^2 + l_y'^2+ l_z'^2)} \\
...
\begin{equation}
	...
	L'_{p} = cT'_{p} = \gamma^2 \frac{u'}{c} l_z' + \gamma  L
\end{equation}
...
\begin{equation}
	...
	\mhl{
		\mathbf{c'} = \frac{c}{ \frac{u'}{c} \gamma \frac{l_z'}{L} + 1}
		\begin{pmatrix}
			\frac{1}{\gamma} \frac{l_x'}{L}  \\
			\frac{1}{\gamma}  \frac{l_y'}{L} \\
			\gamma \frac{l_z'}{L} + \frac{u'}{c}
		\end{pmatrix}
	}
\end{equation}
...
\begin{equation}
	\label{eq: cos alpha prime}
	\cos{\alpha'} = \frac{\gamma \frac{l_z'}{L} + \frac{u'}{c}}{ \frac{u'}{c} \gamma \frac{l_z'}{L} + 1}
\end{equation}
...
\begin{equation}
	\Phi_\Omega = \frac{d\Omega}{d\Omega'} = {\gamma}^2\left(1 + \dfrac{u'}{c}\cos{\alpha}\right)^2.
\end{equation}
...
\begin{equation}
	\Phi_\Omega = {\gamma}^2\left(1 + \dfrac{u'}{c}\frac{\gamma z'}{R}\right)^2.
\end{equation}
...
\begin{equation}
	...
	\Phi_\Omega = \frac{1}{{\gamma}^2\left(1 - \dfrac{u'}{c}\cos{\alpha'}\right)^2}.
\end{equation}
...
% 	\Phi_\Omega =  \frac{1}{{\gamma}^2\left(1 - \dfrac{u'}{c}\frac{\gamma \frac{z'}{ R} + \frac{u'}{c}}{ \frac{u'}{c} \gamma \frac{z'}{ R} + 1}\right)^2} = \gamma^2 \left( 1 +\frac{u'}{c} \gamma \frac{z'}{ R} \right)^2
% \end{equation}

%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{A Moving Source's Relativistic Beaming of its emitted light} \label{ch: A Moving Source's Field}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{Emitted Light's Density}\label{sect: Field Density}

will use these to get inverse square law

%███████████████████████████████████████████████████████████████████
\subsection{Scalar Density of Light}\label{subsect: Field Scalar Density}
...
\begin{equation}
	\frac{1}{L_p'^2} = \frac{1}{\left( \gamma^2 \frac{u'}{c} z' + \gamma  L \right)^2}
\end{equation}

giving the disipation with the angular denisty of the light from equation \eqref{eq: aberration density weighting} as

\begin{equation}
	\frac{\gamma^2 \left( 1 +\frac{u'}{c} \gamma \frac{z'}{ L} \right)^2}{\left( \gamma^2 \frac{u'}{c} z' + \gamma  L \right)^2} = \frac{1}{  L^2}
\end{equation}
...
\begin{equation}
	\Phi_{r} = \frac{d\lambda}{d\lambda{'}} = \frac{1}{ {\gamma} \left(1-\dfrac{u{'}}{c} \cos\alpha{'} \right)}
\end{equation}

Now combining these gives the density of light at any point as

\begin{equation}
	D = \frac{\Phi_{r}}{ L^2} = \frac{1}{{\gamma} \left(1-\dfrac{u{'}}{c} \cos\alpha{'} \right)  L^2}  = \frac{\gamma \left( 1 +\frac{u'}{c} \gamma \frac{z'}{ L} \right)}{ L^2}
\end{equation}
...
%███████████████████████████████████████████████████████████████████
\subsection{Density of Light in a Vector Form}\label{subsect: Field Vector Density}
...
\begin{equation}
	\nabla = (\frac{\partial}{\partial r},\frac{\partial}{\partial\theta},\frac{\partial}{\partial\phi})
\end{equation}
...
\begin{equation}
	\mathbf{D} = (k_r, \frac{k_\theta}{r}, \frac{k_\phi}{r})
\end{equation}
...
\begin{equation}
	\| \nabla \mathbf{D} \| = \frac{\sqrt{k_\theta^2 + k_\phi^2 }}{r^2} = \frac{k_{AngTot}}{r^2}
\end{equation}

\begin{equation}
	\| \mathbf{D} \| = \sqrt{k_r^2 + \frac{k_\theta^2}{r^2} + \frac{k_\phi^2}{r^2}}
\end{equation}

\begin{equation}
	\| ( \nabla \| \mathbf{D} \| ) \| = \frac{k_\theta^2 + k_\phi^2}{r^3\sqrt{k_r^2 + \frac{k_\phi^2 + k_\theta^2}{r^2}}} = \frac{k_\theta^2 + k_\phi^2}{\sqrt{k_r^2 r^6 + \left(k_\phi^2 + k_\theta^2\right)r^4}}
\end{equation}

if $k_r$ is insignificant then

\begin{equation}
	\| ( \nabla \| \mathbf{D} \| ) \| \approx \frac{k_\theta^2 + k_\phi^2}{r^3\sqrt{ \frac{k_\phi^2 + k_\theta^2}{r^2}}} = \frac{k_{ang-tot}}{r^2}
\end{equation}
...
\begin{equation}
	\mathbf{D} = \left(\frac{k_r}{\gamma( 1 - u'/c \cos{\alpha'})}, \frac{k_\theta}{L}, \frac{k_\phi}{L} \right)
\end{equation}

using equation \eqref{eq: cos alpha prime} and $L = \sqrt{x'^2+y'^2+\gamma^2z'^2}$

giving

\begin{equation}
	\frac{1}{{\gamma} \left(1-\dfrac{u{'}}{c} \cos\alpha{'} \right)}  = \gamma \left( 1 +\frac{u'}{c} \gamma \frac{z'}{L} \right)
\end{equation}

and using $\beta = - u'/c$ we have

\begin{equation}
	\mathbf{D} = \left(k_r \gamma( 1 - \beta \frac{\gamma z'}{\sqrt{x'^2+y'^2+\gamma^2 {z'}^2}}), \frac{k_\theta}{\sqrt{x'^2+y'^2+\gamma^2z'^2}}, \frac{k_\phi}{\sqrt{x'^2+y'^2+\gamma^2z'^2}} \right)
\end{equation}
...
\begin{equation}
	...
	\begin{pmatrix}
		k_r \gamma^2 \beta x'z' & k_r \gamma^2 \beta y'z' & - k_r \gamma^2 \beta (x'^2 +y'^2)  \\
		-k_\theta x' & -k_\theta y' & -k_\theta\gamma^2 z' \\
		-k_\phi x' & -k_\phi y' & -k_\phi\gamma^2 z'
	\end{pmatrix}
\end{equation}

\begin{equation}
	\| \nabla \mathbf{D} \| = \frac{1}{L^3} \sqrt{\left( k_\theta^2 +k_\phi^2 + k_r^2 \gamma^4 \beta^2 ( z^2 - 1 ) (x^2+y^2) \right)L^2}
\end{equation}
...
\begin{equation}
	\| \nabla \mathbf{D} \| = \frac{1}{L^2} \sqrt{ k_\theta^2 +k_\phi^2 + k_r^2 \gamma^4 \beta^2 ( z^2 - 1 ) (x^2+y^2) }
\end{equation}

if $k_r\approx 0$ then

\begin{equation}
	\| \nabla \mathbf{D} \| = \frac{\sqrt{ k_\theta^2 +k_\phi^2 }}{L^2}
\end{equation}

now lets look at $\|\left(\nabla \|\mathbf{D}\| \right) \|$
...
\begin{equation}
	\|\mathbf{D}\| = \sqrt{ \frac{k_\theta^2 + k_\phi^2}{L^2} + k_r^2 \gamma^2\left( 1-\beta \gamma \frac{z'}{L} \right)^2 } = \sqrt{ \frac{k_a^2}{L^2} + k_r^2 \gamma^2\left( 1-\beta \gamma \frac{z'}{L} \right)^2 }
\end{equation}

\begin{equation}
	\nabla \|\mathbf{D}\| = \frac{1}{L^3 \sqrt{\frac{K_a^2}{L^2} + k_r^2\gamma^2(1-\gamma\beta\frac{z'}{L})^2}}
	\begin{pmatrix}
		-\frac{x'}{L} k_a^2 + k_r^2 \gamma^3 \beta (1-\gamma\beta \frac{z'}{L}) x'z' \\
		-\frac{y'}{L} k_a^2 + k_r^2 \gamma^3 \beta (1-\gamma\beta \frac{z'}{L}) y'z' \\
		-\gamma^2\frac{z'}{L} k_a^2 - k_r^2 \gamma^3 \beta (1-\gamma\beta \frac{z'}{L}) (x'^2 + y'^2)
	\end{pmatrix}
\end{equation}

$e=\frac{1}{L^3 \sqrt{\frac{K_a^2}{L^2} + k_r^2\gamma^2(1-\gamma\beta\frac{z'}{L})^2}}$,

$f= k_r^2 \gamma^3 \beta (1-\gamma\beta \frac{z'}{L})$
...
\begin{equation}
	\|\left(\nabla \|\mathbf{D}\| \right) \| = e \sqrt{ (x'^2+y'^2+\gamma^4 z'^2) \frac{a^2}{L^2} + (x'^4 + y'^4) (z'^2 + 1) f^2 + (\gamma^2 - 1 ) (x'^2 + y'^2 ) \frac{2fa z'}{L} }
\end{equation}
...
\begin{equation}
	\|\left(\nabla \|\mathbf{D}\| \right) \| = \frac{k_a}{ L^2} \sqrt{ \frac{x'^2+y'^2+\gamma^4 z'^2}{x'^2+y'^2+\gamma^2 z'^2} }
\end{equation}
...
\begin{equation}
	\mathbf{\hat{c}} = \frac{1}{ \frac{u'}{c} \gamma \frac{z}{L} + 1 }
	\begin{pmatrix}
		\frac{1}{\gamma} \frac{x}{L} \\
		\frac{1}{\gamma} \frac{y}{L} \\
		\gamma \frac{z}{L} + \frac{u'}{c}
	\end{pmatrix}
\end{equation}
...
\begin{equation}
	\mhl
	{
		\begin{aligned}
			...
			\frac{1}{\gamma  R ( \frac{u'}{c} \frac{\gamma z}{L} + 1 )^2}
			\begin{pmatrix}
				1 - \frac{x^2}{ R^2} + \frac{u'}{c}\frac{\gamma z}{L} \\
				- \frac{x}{L} \frac{y}{L}                             \\
				- \frac{x}{L} \frac{z}{L}
			\end{pmatrix}                                                               \\
			...
			\begin{pmatrix}
				- \frac{y}{L} \frac{x}{L}                             \\
				1 - \frac{y^2}{ R^2} + \frac{u'}{c}\frac{\gamma z}{L} \\
				- \frac{y}{L} \frac{z}{L}
			\end{pmatrix}                                                               \\
			\frac{\partial \mathbf{\hat{c}}}{\partial z} & = \frac{1}{\gamma  R
				(  \frac{u'}{c} \frac{\gamma z}{L} +  1 )^2}
			\begin{pmatrix}
				\gamma ( - \frac{u'}{c}  - \frac{ \gamma z }{L} ) \frac{x}{L} \\
				\gamma ( - \frac{u'}{c}  - \frac{\gamma z }{L} ) \frac{y}{L}  \\
				\frac{ x^2 + y^2 }{ R^2}
			\end{pmatrix}                                                    \\
			\frac{\partial \mathbf{\hat{c}}}{\partial t} & = \frac{-u'}{\gamma  R (  \frac{u'}{c} \frac{\gamma z}{L} +  1 )^2}
			\begin{pmatrix}
				\gamma ( - \frac{u'}{c}  - \frac{ \gamma z }{L} ) \frac{x}{L} \\
				\gamma ( - \frac{u'}{c}  - \frac{\gamma z }{L} ) \frac{y}{L}  \\
				\frac{ x^2 + y^2 }{ R^2}
...
\begin{equation}
	mag = \sqrt{ (1 - \frac{x^2}{ R^2} + \frac{u'}{c}\frac{\gamma z}{L})^2 + 2\frac{x^2y^2}{ R^4} + \frac{x^2z^2}{ R^4} +	(1 - \frac{y^2}{ R^2} + \frac{u'}{c}\frac{\gamma z}{L})^2 + \frac{y^2z^2}{ R^4} +	(\gamma ( \frac{u'}{c}  + \frac{ \gamma z }{L} ) \frac{x}{L})^2 + (\gamma ( \frac{u'}{c}  + \frac{\gamma z }{L} ) \frac{y}{L})^2 + (\frac{ x^2 + y^2 }{ R^2})^2 }
\end{equation}
...
% \begin{equation}
% 	\mathbf{\hat{c}} \cdot \frac{\partial \mathbf{\hat{c}}}{\partial x} = x (1 - \frac{x^2}{ R^2} + \frac{u}{c}\frac{\gamma z}{L}) + y (- \frac{x}{L} \frac{y}{L}) + (\gamma^2 z + \gamma \frac{u}{c}  R)(- \frac{x}{L} \frac{z}{L})=0
% \end{equation}

% \begin{equation}
% 	\mathbf{\hat{c}} \cdot \frac{\partial \mathbf{\hat{c}}}{\partial z} = x (( - \frac{u}{c}  - \frac{ \gamma z }{L} ) \frac{x}{L}) + y (( - \frac{u}{c}  - \frac{\gamma z }{L} ) \frac{y}{L}) + (\gamma^2 z + \gamma \frac{u}{c}  R)(\frac{1}{\gamma}\frac{ x^2 + y^2 }{ R^2})=0
% \end{equation}
...
\textbf{light from a stationary source:}
...
\begin{equation}
	\begin{aligned}
		\left(\frac{dS_p}{d\tau}\right)^2 & = \left(c\frac{{{dt}_{p}}}{d\tau}\right)^2-\left(c\frac{dx_p}{d\tau}\right)^2-\left(\frac{dy_p}{d\tau}\right)^2-\left(\frac{dz_p}{d\tau}\right)^2 \\
		                                  & = {c}^2\gamma^2 \left( 1-\frac{{{u}_{x}}^2 + {{u}_{y}}^2 + {{u}_{z}}^2}{{c}^2} \right) = {c}^2\gamma^2 \left( 1-\frac{u^2}{{c}^2} \right) \\
		                                  & = {c}^2
	\end{aligned}
\end{equation}
...
\begin{equation}
	...
	\begin{aligned}
		m^2 {c}^2 \left(\frac{dS_p}{d\tau}\right)^2 & = \gamma^2 m^2 c^4-\gamma^2 m^2 \left( {{u}_{x}}^2 + {{u}_{y}}^2 + {{u}_{z}}^2 \right) {c}^2 \\
		({m}{c}^2)^2                                & = \gamma^2 m^2 c^4-\gamma^2 m^2 u^2 {c}^2
	\end{aligned}
\end{equation}
...
\begin{equation}
	...
	\left( \gamma m {c}^2 \right)^2 = ({m}{c}^2)^2 + \left( \gamma {m}{u}{c}\right)^2
\end{equation}
...
\begin{equation}
	\gamma = 1 + \frac{1}{2}\frac{u^2}{{c}^2} + \frac{3}{8}\frac{u^4}{c^4} + ...
\end{equation}
...
\begin{equation}
	E^2 = \left( {m}{c}^2 \right)^2 + (\gamma{m}{u})^2{c}^2
\end{equation}
...
\begin{equation}
	\begin{aligned}
		\gamma {m}{u}{c} & = {m}{u}{c} \left(1 + \frac{1}{2}\frac{u^2}{{c}^2} + \frac{3}{8}\frac{u^4}{c^4} + ...
		\right)                                                                                                       \\
