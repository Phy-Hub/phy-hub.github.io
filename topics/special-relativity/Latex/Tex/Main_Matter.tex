...
%█████████████
\begin{figure}[H]
	\figuretitle{Reference Frames of a Truck and Road}
	\centering
...
If we have a source at rest, emitting circular pulses of light with equal times between each pulse, we will have concentric circular pulses in this frame.
...
%█████████████
\begin{figure}[htbp]
	\figuretitle{Aberration of Light on a truck}
	\centering
...
It is based on two assumptions, which are that \textbf{in each frame, you would observe the following:}
...
That is, the first \hyperlink{def-observer}{observer} would see a stick and measure it to be the same length as another \hyperlink{def-observer}{observer} who is moving relative to the first would measure it.
...
We need to know how to transform the positions and times of the particle into this second observers frame.
...
So let us see how the mathematics works for the classical coordinate system transform between two inertial observers frames, by looking at the coordinates of an event in an initial reference frame with a second inertial frame's coordinate axis moving relative to the initial frame's axis, illustrated in Figure (\ref{fig: simple Galilean transform derivation}):
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale = 3]%,tdplot_main_coords]
		...
		%
		\draw[red, thick,->] (1.7,0,0)--(3.02,0.87,0) node[midway,anchor = north]{${\vec{OE}}$};
...
These are the equations that define classical relativity, we can compare this to the equations of the coordinate transforms in special relativity later. They define the event's location relative to whichever frame that we are in's axis. The special relativistic equations later will look similar to these, but with an extra factor in the z-component and with the time will no longer be consistent in both frames.
...
This shows the symmetry between the frames. If we were originally in the primed frame we would have the initial frame now moving at a speed -${v}$ in the z-direction relative to it, so we would expect that the inverse \hyperlink{def-transform}{transformation} would just replace one frame's coordinates with the other and have the opposite \hyperlink{def-frame-velocity}{frame velocity}, as it is shown to have in the transforms.
So the inverse, going from \hyperlink{def-Primed-Frame}{primed frame} to original is just a matter of swapping all primed an initial coordinates and changing the sign on the \hyperlink{def-frame-velocity}{frame velocity}
...
We will now use these assumptions with the concept of a light clock.
...
\begin{figure}[H]
	...
	\begin{subfigure}{.49\textwidth}
		...
		\caption{Moving frame}
	\end{subfigure}
	\caption{\textbf{Light clock showing time dilation.} The light clock keeps time by counting each time the light makes a return journey when bouncing between two mirrors with length ${L}=\frac{1}{2}{c}{\Delta \tau}$ between them, the diagram shows the mirror's rest frame (left) and a frame with them moving at speed ${u}=-{v}$ (right). In this second frame, there is a distance ${u}{\Delta t{'}}$ between where the light was reflected by the left mirror and where it returned to it. For this, the light had to travel a total diagonal distance of ${c}{\Delta t{'}}$ to return.}
...
This is the hypotenuse of a right angled triangle formed by ${v}{\Delta t{'}}$ and $2{L}$, so we have the square of the hypotenuse equal to the square of the other two lengths:
...
Now from these, we find that the time for the return journey in the frame with the clock moving is longer relative to its rest frame,

\begin{equation}
	{\Delta t{'}} \geq {\Delta\tau}
\end{equation}

We take this outcome as the time taken between two \hyperlink{def-event}{event}s in the same position in the moving frame takes longer than in the \hyperlink{def-proper-frame}{rest frame} of the clock, due to the longer distance it must travel at the same speed.
Hence systems that are moving seem to have there time flowing slower, one example of this is that unstable particle that are moving faster have longer livespans before they decay.
...
To explain why it happens we will add a second perpendicular reflected light path to previous section's experimental setup.
...
In the moving frame, the pulse sent forward has a path length equal to the speed of light times the time of the path which is also equal to the distance between the bulb and mirror plus the distance the mirror has moved away from the point it was emitted in this time

\begin{equation}
	{l^{'}_1} = {c}{\Delta t^{'}_1} = {\Delta  L^{'}} + {u} {\Delta t^{'}_1}
\end{equation}

where ${u}$ is the speed that the front mirror is moving away from the point it was emitted, ${\Delta t^{'}_1}$ is the time taken to get to the mirror, and ${\Delta  L^{'}}$ is the distance between the bulb and the mirror in front.
...
Where ${\Delta t^{'}_2}$ is the time taken to return to the bulb from the front mirror, both of these give the two times as
...
This means that for a system moving relative to an observer the distances in the system in the direction of movement are contracted compared to the rest frame of the object, that is
...
The displacement between the initial frame's origin and the event's position in the initial frame is
...
The primed frame's axis and coordinates are moving relative to the initial frame, so from the previous section we would have the distance between the primed axis origin and the event length contracted in the initial frame relative to these coordinates in the primed frame, that is the z component of $\vec{O{'}E}$ in the initial frame is equal to 
...
${z} = {z{'}}/{\gamma}$, giving the distance between the primed axis origin and the event in the initial frame in terms of the primed z-coordinate as
...
In the time \hyperlink{def-transform}{transform} equation the $\frac{{v}{z}}{{c}^2}$ term is the cause of \hyperlink{def-simultaneity}{simultaneous} \hyperlink{def-event}{event}s in one inertial frame no longer being \hyperlink{def-simultaneity}{simultaneous} in another inertial frame, and the ${\gamma}$ factor, is the term that causes the overall change in how fast time flows relative in each frame.
...
rearranging and replacing the difference of the first and second of each coordinate, ${\Delta}{\vec{R}} = ({\Delta}x,{\Delta}y,{\Delta}z) = (x_2-x_1,y_2-y_1,z_2-z_1)$, giving the displacement transform as
...
Now, divide by the time differential as we did for the velocity in the previous section, we get the acceleration transform as
...
We derived the mathematics for the transformation of the time and spatial coordinates for classical relativity to help us with our the understanding of the derivation of special relativity.
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\chapter{Observers Delayed World View} \label{ch: Observers Delayed World View}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{Delayed View of Transformed Coordinates} \label{sect: Delayed View of Transformed Coordinates}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{Spherical Polar Coordinates} \label{sect: Spherical Polar Coordinates}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{Light Speed Velocity Transform} \label{sect: Light Speed Velocity Transform}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\section{Transform of Light Pulse from Origin} \label{sect: Transform of Light Pulse from Origin}
...
%███████████████████████████████████████████████████████████████████
%███████████████████████████████████████████████████████████████████
\chapter{A Moving Source's Field} \label{ch: A Moving Source's Field}
...
% %███████████████████████████████████████████████████████████████████
%\chapter{"zitterbewegung"} \label{ch: "zitterbewegung"}

% %███████████████████████████████████████████████████████████████████
% \chapter{equation for motion in primed frame for arbitrary motion in proper frame} \label{ch: equation for motion in primed frame for arbitrary motion in proper frame}

% %███████████████████████████████████████████████████████████████████
% \chapter{None Point Like Sources} \label{ch: None Point Like Sources}
